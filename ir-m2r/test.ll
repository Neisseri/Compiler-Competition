...
B18:
  %r273 = phi tmp#23 i32 [ %r272, %B68 ]
  %r269 = phi t#11 i32 [ %r5, %B17 ], [ %r9, %B68 ]
  %r268 = phi m#11 i32 [ %r12, %B68 ]
  %r267 = phi logic_expr@#79 i32 [ %r266, %B68 ]
  %r263 = phi logic_expr@#178 i32 [ %r262, %B68 ]
  %r259 = phi logic_expr@#177 i32 [ %r258, %B68 ]
  %r255 = phi logic_expr@#152 i32 [ %r254, %B68 ]
  %r251 = phi logic_expr@#126 i32 [ %r250, %B68 ]
  %r247 = phi logic_expr@#103 i32 [ %r246, %B68 ]
  %r243 = phi loc#16 i32 [ %r242, %B68 ]
  %r240 = phi k#13 i32 [ %r27, %B68 ]
  %r238 = phi i#13 i32 [ %r239, %B68 ]
  %r234 = phi flag#13 i32 [ %r237, %B68 ]
  %r233 = phi b#11 i32 [ %r232, %B68 ]
  %r231 = phi a#11 i32 [ %r230, %B68 ]
...
B21:
  %r272 = phi tmp#23 i32 [ %r273, %B19 ], [ %r271, %B26 ]
  %r266 = phi logic_expr@#79 i32 [ %r267, %B19 ], [ %r265, %B26 ]
  %r262 = phi logic_expr@#178 i32 [ %r263, %B19 ], [ %r261, %B26 ]
  %r258 = phi logic_expr@#177 i32 [ %r259, %B19 ], [ %r257, %B26 ]
  %r254 = phi logic_expr@#152 i32 [ %r255, %B19 ], [ %r253, %B26 ]
  %r250 = phi logic_expr@#126 i32 [ %r251, %B19 ], [ %r249, %B26 ]
  %r246 = phi logic_expr@#103 i32 [ %r247, %B19 ], [ %r245, %B26 ]
  %r242 = phi loc#16 i32 [ %r243, %B19 ], [ %r241, %B26 ]
  %r239 = phi i#13 i32 [ %r14, %B19 ], [ %r219, %B26 ]
  %r237 = phi flag#13 i32 [ %r16, %B19 ], [ %r236, %B26 ]
  %r232 = phi b#11 i32 [ %r233, %B19 ], [ %r32, %B26 ]
  %r230 = phi a#11 i32 [ %r231, %B19 ], [ %r31, %B26 ]
...
B25:
  ...
  %r50 = mul i32 %r44, %r48
  %r51 = add i32 %r47, %r50
  store array#0 i32 %r44, ptr %r51
  br label %B27

B26:
  %r271 = phi tmp#23 i32 [ %r272, %B24 ], [ %r270, %B65 ]
  %r265 = phi logic_expr@#79 i32 [ %r266, %B24 ], [ %r264, %B65 ]
  %r261 = phi logic_expr@#178 i32 [ %r262, %B24 ], [ %r260, %B65 ]
  %r257 = phi logic_expr@#177 i32 [ %r258, %B24 ], [ %r256, %B65 ]
  %r253 = phi logic_expr@#152 i32 [ %r254, %B24 ], [ %r252, %B65 ]
  %r249 = phi logic_expr@#126 i32 [ %r250, %B24 ], [ %r248, %B65 ]
  %r245 = phi logic_expr@#103 i32 [ %r246, %B24 ], [ %r244, %B65 ]
  %r241 = phi loc#16 i32 [ %r242, %B24 ], [ %r44, %B65 ]
  %r236 = phi flag#13 i32 [ %r237, %B24 ], [ %r235, %B65 ]
...
B36:
  %r264 = phi logic_expr@#79 i32 [ %r95, %B34 ], [ %r96, %B35 ]
...
B42:
  %r244 = phi logic_expr@#103 i32 [ %r118, %B40 ], [ %r119, %B41 ]
...
B48:
  %r248 = phi logic_expr@#126 i32 [ %r143, %B46 ], [ %r144, %B47 ]
...
B54:
  %r252 = phi logic_expr@#152 i32 [ %r168, %B52 ], [ %r169, %B53 ]
...
B60:
  %r260 = phi logic_expr@#178 i32 [ %r198, %B58 ], [ %r199, %B59 ]
...
B63:
  %r256 = phi logic_expr@#177 i32 [ %r205, %B61 ], [ %r206, %B62 ]
...
B65:
  %r270 = phi tmp#23 i32 [ %r272, %B63 ], [ %r212, %B64 ]
  %r235 = phi flag#13 i32 [ %r237, %B63 ], [ %r208, %B64 ]
  br label %B26
