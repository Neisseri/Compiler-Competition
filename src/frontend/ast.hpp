...
namespace frontend
{
    ...
    namespace ast
    {
        ...
        private:
            std::shared_ptr<SysYType> type;
            Identifier id;
            std::shared_ptr<Initializer> expr = nullptr;

        public:
            Declaration() = default;
            Declaration(std::shared_ptr<SysYType> type, Identifier id, std::shared_ptr<Initializer> expr)
            ...
            std::shared_ptr<SysYType> getType() const { return type; }
            Identifier getId() const { return id; }
            std::shared_ptr<Initializer> getExpr() const { return expr; }
        };
