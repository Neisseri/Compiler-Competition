...
namespace riscv {
    ...
    constexpr const int argregs[7] = {a1, a2, a3, a4, a5, a6, a7};
    constexpr const int argregs_full[8] = {a0, a1, a2, a3, a4, a5, a6, a7};

    constexpr const int allocable_regs[26] = {t0, t1, t2, s1, a0, a1, a2, a3, a4, a5, 
