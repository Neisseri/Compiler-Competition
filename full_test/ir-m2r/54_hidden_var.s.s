...
B0:
  ...
  %r8 = call i32 @putint(i32 %r5)
  %r10 = call i32 @putint(i32 %r2)
  %r13 = add i32 0, 10 ; loadint
  %r12 = call i32 @putch(i32 %r13)
  br label %B1

B1:
  %r283 = add i32 0, %r21 ; assign
  %r15 = add i32 0, 5 ; loadint
  %r16 = icmp slt i32 %r2, %r15
...
B3:
  %r284 = phi i32 [ %r283, %B1 ], [ %r21, %B5 ]
  %r23 = call i32 @putint(i32 %r2)
