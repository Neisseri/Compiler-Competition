...
B1:
  %r64 = phi i32 [ %r4, %B0 ], [ %r62, %B6 ]
  %r69 = add i32 0, %r68 ; assign
  %r65 = add i32 0, %r66 ; assign
  %r6 = loadaddr @n#0
  %r7 = load i32, ptr %r6
  %r8 = add i32 0, 1 ; loadint
  %r9 = sub i32 %r7, %r8
  %r10 = icmp slt i32 %r64, %r9
...
B4:
  %r68 = phi i32 [ %r69, %B2 ], [ %r67, %B9 ]
  %r66 = phi i32 [ %r11, %B2 ], [ %r59, %B9 ]
  %r13 = loadaddr @n#0
  %r14 = load i32, ptr %r13
  %r16 = sub i32 %r14, %r64
  %r17 = add i32 0, 1 ; loadint
  %r18 = sub i32 %r16, %r17
  %r19 = icmp slt i32 %r66, %r18
...
B8:
  ...
  %r55 = mul i32 %r66, %r53
  %r56 = add i32 %r1, %r55
  store i32 %r40, ptr %r56
  br label %B9

B9:
  %r67 = phi i32 [ %r68, %B7 ], [ %r40, %B8 ]
