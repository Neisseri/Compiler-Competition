...
B27:
  %r80 = phi i32 [ %r58, %B26 ], [ %r78, %B28 ]
  %r81 = add i32 0, %r73 ; assign
  %r62 = loadaddr @n#0
...
B3:
  %r122 = add i32 0, %r101 ; assign
  %r121 = add i32 0, %r119 ; assign
  %r117 = add i32 0, %r115 ; assign
  %r113 = add i32 0, %r18 ; assign
  %r109 = add i32 0, %r111 ; assign
  %r105 = add i32 0, %r107 ; assign
  %r104 = add i32 0, 0 ; loadint
  ret i32 %r104

B4:
  %r111 = phi i32 [ %r3, %B2 ], [ %r112, %B24 ]
  %r107 = phi i32 [ %r2, %B2 ], [ %r108, %B24 ]
  %r119 = add i32 0, %r118 ; assign
  %r115 = add i32 0, %r114 ; assign
...
B7:
  %r116 = phi i32 [ %r115, %B5 ], [ %r114, %B8 ]
  %r110 = phi i32 [ %r111, %B5 ], [ %r39, %B8 ]
...
B15:
  %r106 = phi i32 [ %r107, %B13 ], [ %r54, %B14 ]
  br label %B16

B16:
  %r120 = phi i32 [ %r119, %B15 ], [ %r118, %B17 ]
  %r108 = phi i32 [ %r106, %B15 ], [ %r70, %B17 ]
