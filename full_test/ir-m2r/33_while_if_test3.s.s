...
B1:
  %r35 = phi i32 [ %r8, %B0 ], [ %r34, %B6 ]
  %r41 = add i32 0, %r40 ; assign
  %r38 = add i32 0, %r13 ; assign
...
B6:
  %r40 = phi i32 [ %r41, %B4 ], [ %r39, %B9 ]
  %r34 = phi i32 [ %r35, %B4 ], [ %r37, %B9 ]
  br label %B1
...
B9:
  %r39 = phi i32 [ %r41, %B7 ], [ %r26, %B12 ]
  %r37 = phi i32 [ %r19, %B7 ], [ %r36, %B12 ]
  br label %B6
