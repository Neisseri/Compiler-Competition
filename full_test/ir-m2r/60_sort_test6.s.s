...
B15:
  %r79 = phi i32 [ %r57, %B14 ], [ %r77, %B16 ]
  %r80 = add i32 0, %r72 ; assign
  %r61 = loadaddr @n#0
  %r62 = load i32, ptr %r61
  %r63 = icmp slt i32 %r79, %r62
...
B16:
  ...
  %r70 = call i32 @putint(i32 %r69)
  %r72 = add i32 0, 10 ; loadint
  %r73 = call i32 @putch(i32 %r72)
...
B4:
  %r124 = phi i32 [ %r10, %B3 ], [ %r47, %B5 ]
  %r25 = icmp slt i32 %r124, %r3
  br i1 %r25, label %B5, label %B6

B5:
  %r26 = add i32 0, 4 ; loadint
  %r27 = add i32 0, 4 ; loadint
  %r29 = mul i32 %r124, %r27
  %r30 = add i32 %r1, %r29
...
B10:
  %r125 = phi i32 [ %r3, %B9 ], [ %r122, %B11 ]
  %r74 = add i32 0, 0 ; loadint
  %r75 = icmp sgt i32 %r125, %r74
