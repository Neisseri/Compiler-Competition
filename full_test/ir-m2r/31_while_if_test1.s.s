...
B1:
  %r25 = phi i32 [ %r4, %B0 ], [ %r24, %B7 ]
  %r23 = phi i32 [ %r2, %B0 ], [ %r21, %B7 ]
  %r6 = add i32 0, 100 ; loadint
  %r7 = icmp slt i32 %r23, %r6
